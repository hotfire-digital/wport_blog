...
![聰電站活動現場 Banner](https://lh3.googleusercontent.com/d/11NemE2yMGwu9ILq4Q5K4jchbYln-0Twy)
...
![聰電站活動現場，學員們認真參與課程](https://lh3.googleusercontent.com/d/1eG45iEMtni4qo-EmKvNHxYeN9zP3_U_5)
...
![講師在大螢幕前帶著學員實作](https://lh3.googleusercontent.com/d/15FlcUK0JpH4S0y7rMOcfdCOUDrksNQgL)

大螢幕同步顯示操作步驟，講師邊示範邊說明背後的邏輯，不只教你「怎麼做」，也讓你知道「為什麼這樣做」。

![學員們專注地在筆電上跟著操作](https://lh3.googleusercontent.com/d/1stuy9ChCSHlAWkt2c33YmFHP8yktSpMF)

活動結束時，每位學員的筆電裡都有實際跑起來的成果，不是一份投影片、不是一張證書，而是你自己做出來的東西。

![聰電站全體合照](https://lh3.googleusercontent.com/d/1EnldLCnm4ZZI5dbuqPd-4hDCdB-napZt)
...
<div style="display: flex; flex-direction: column; gap: 10px; margin: 16px 0;">
  ...
  <div style="display: flex; flex-direction: column; justify-content: center; height: 110px; box-sizing: border-box; padding: 0 20px; background: #f9f9f9; border-radius: 10px; border: 1px solid #e8e8e8;">
